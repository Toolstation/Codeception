...
class ExtensionsCest
{
    ...
    public function useAlternativeFormatter(CliGuy $I)
    {
        ...
        $I->executeCommand('run tests/dummy/FileExistsCept.php -c codeception_extended.yaml');
    ...
    {
        $I->amInPath('tests/data/sandbox');
        $I->executeCommand('run unit -c codeception_extended.yaml --no-exit');
...
EOF
        ...
        $I->executeCommand('run -g failed -c codeception_extended.yaml --no-exit');
